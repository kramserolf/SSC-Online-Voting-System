    ...
    <div class= "border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <div class="dropdown-menu dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">BSBA / ABEC</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container">
        ...
        <table class="table table-bordered table-hover" id="tbl_bsba">
          ...
          <?php  
            include '../../dbcon.php';
            $sql = mysqli_query($conn, "SELECT * FROM students WHERE course = 'BSBA' or course = 'ABEC'");
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  ...
                  <a href="../function/delete_student_bsba.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash-o"></i></a>
                </td>
              </tr>
