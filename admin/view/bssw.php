    ...
    <div class= "border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <div class="dropdown-menu dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">BSSW / BSTM</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container">
        <div class="d-flex text-black pt-3">
          <div class="w-100">
            <h4>Social Welfare and Tourism Management</h4>
          </div>
        ...
        <!-- cics table -->
        <table class="table table-bordered table-hover" id="tbl_bssw">
          ...
          <?php  
            include '../../dbcon.php';
            $sql = mysqli_query($conn, "SELECT * FROM students WHERE course = 'BSSW' or course = 'BSTM'");
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  ...
                  <a href="../function/delete_student_bssw.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash-o"></i></a>
                </td>
              </tr>
